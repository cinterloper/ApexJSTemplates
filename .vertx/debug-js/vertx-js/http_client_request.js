...
var HttpClientRequest = function(j_val) {
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpClientRequest.exceptionHandler(function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpClientRequest.handler(function(jVal) {
      handler(new HttpClientResponse(jVal));
    });
      return that;
    } else utils.invalidArgs();
  };
  ...
  this.method = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return (j_httpClientRequest.method()).toString();
    } else utils.invalidArgs();
  };
  ...
  this.headers = function() {
    ...
    if (__args.length === 0) {
      if (that.cachedheaders == null) {
        that.cachedheaders = new MultiMap(j_httpClientRequest.headers());
      }

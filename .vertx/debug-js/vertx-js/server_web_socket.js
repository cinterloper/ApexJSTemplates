...
var ServerWebSocket = function(j_val) {
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_serverWebSocket.exceptionHandler(function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_serverWebSocket.handler(function(jVal) {
  ...
  this.writeMessage = function(data) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_serverWebSocket.writeMessage(data._jdel);
      return that;
    } else utils.invalidArgs();
  };
  ...
  this.frameHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_serverWebSocket.frameHandler(function(jVal) {
